...
# installed.
TCL_PREFIX='D:/as/activepython/build/py2_7_8-win32-x86-apy27-rrun/tcltk'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/as/activepython/build/py2_7_8-win32-x86-apy27-rrun/tcltk'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/d/as/activepython/build/py2_7_8-win32-x86-apy27-rrun/tcl/win -ltcl85'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-LD:/as/activepython/build/py2_7_8-win32-x86-apy27-rrun/tcltk/lib -ltcl85'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/as/activepython/build/py2_7_8-win32-x86-apy27-rrun/tcltk/include'
...
# compiled.
TCL_SRC_DIR='/d/as/activepython/build/py2_7_8-win32-x86-apy27-rrun/tcl'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='D:/as/activepython/build/py2_7_8-win32-x86-apy27-rrun/tcltk/lib'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/d/as/activepython/build/py2_7_8-win32-x86-apy27-rrun/tcl/win -ltclstub85'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/as/activepython/build/py2_7_8-win32-x86-apy27-rrun/tcltk/lib -ltclstub85'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/d/as/activepython/build/py2_7_8-win32-x86-apy27-rrun/tcl/win/tclstub85.lib'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='D:/as/activepython/build/py2_7_8-win32-x86-apy27-rrun/tcltk/lib/tclstub85.lib'
