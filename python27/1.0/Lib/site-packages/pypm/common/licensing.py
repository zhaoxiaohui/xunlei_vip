    ...
    try:
        ...
        try:
            ...
            if sys.platform == 'win32':
                ...
                import pwd
                real_home = pwd.getpwuid(os.getuid()).pw_dir or os.getenv('HOME')
                if sys.platform.startswith('darwin'):
                    asdir = P.join(real_home,
                                   'Library/Application Support/ActiveState')
                else:
                    asdir = P.join(real_home, '.ActiveState')
