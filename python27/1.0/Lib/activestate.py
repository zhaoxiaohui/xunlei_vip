...
version_info = {'bsddb_ver': None,
 'build_host': 'python-win32',
 'build_num': 10,
 'build_plat_fullname': 'win32-7-x86',
 'build_plat_name': 'win32-x86',
 'build_time': 'Wed Jul 02 20:10:54 2014',
 'bzip2_ver': (1, 0, 6),
 'compiler': 'vc9-x86',
 'configuration': ['-v',
                   '-f',
...
prefixes = set([
    ...
    'D:\\as\\activepython\\build\\py2_7_8-win32-x86-apy27-rrun\\ExTAcTiVePyThOnPrEfIxExTAcTiVePyThOnPrEfIxExTAcTiVePyThOnPrEfIxExTAcTiVePyThOnPrEfIxExTAcTiVePyThOnPrEfIxExTAcTiVePyThOnPrEfIxExTAcTiVePyThOnPrEfIxExTAcTiVePyThOnPrEfIxExTAcTiVePyThOnPrEfIxExTAcTiVePyThOnPrEfIx',
    # Prefix to which Python sources were built.
    'D:\\as\\activepython\\build\\py2_7_8-win32-x86-apy27-rrun\\CoReAcTiVePyThOnPrEfIxCoReAcTiVePyThOnPrEfIxCoReAcTiVePyThOnPrEfIxCoReAcTiVePyThOnPrEfIxCoReAcTiVePyThOnPrEfIxCoReAcTiVePyThOnPrEfIxCoReAcTiVePyThOnPrEfIxCoReAcTiVePyThOnPrEfIxCoReAcTiVePyThOnPrEfIxCoReAcTiVePyThOnPrEfIx',
    # Prefix to the Python image (sys.prefix)
    # (relied by pypm -- for relocation)
    'D:\\as\\activepython\\build\\py2_7_8-win32-x86-apy27-rrun\\image\\feature-core\\INSTALLDIR',
])
shortest_original_prefix_length = 264
